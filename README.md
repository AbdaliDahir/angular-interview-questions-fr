...
|15 | [What is metadata?](#what-is-metadata)| 16 | [What is Angular CLI?](#what-is-angular-cli)
|17 | [constructor vs ngOnInit?](#what-is-the-difference-between-constructor-and-ngoninit)| 18 |[Dependency injection in Angular?](#what-is-dependency-injection-in-angular)|
|19| [How is Dependency Hierarchy formed?](#how-is-dependency-hierarchy-formed)| 20 | [What is the purpose of async pipe?](#what-is-the-purpose-of-async-pipe)|
|21| [inline vs external template file?](#what-is-the-option-to-choose-between-inline-and-external-template-file)| 22 | [*ngFor directive?](#what-is-the-purpose-of-ngfor-directive)
